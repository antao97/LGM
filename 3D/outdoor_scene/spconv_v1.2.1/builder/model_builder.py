...
from network.segmentator_3d_asymm_spconv import Asymm_3d_spconv, New_Asymm_3d_spconv
from network.cylinder_fea_generator import cylinder_fea, New_cylinder_fea
...
def build(model_config):
    ...
    New_cylinder_3d_spconv_seg = New_Asymm_3d_spconv(
        output_shape=output_shape,
        use_norm=use_norm,
        num_input_features=num_input_features,
        init_size=init_size,
    ...
    New_cy_fea_net = New_cylinder_fea(grid_size=output_shape,
                              fea_dim=fea_dim,
                              out_pt_fea_dim=out_fea_dim,
                              fea_compre=num_input_features)
    ...
    New_model = get_model_class(model_config["New_model_architecture"])(
        cylin_model=New_cy_fea_net,
        segmentator_spconv=New_cylinder_3d_spconv_seg,
        sparse_shape=output_shape
    )
