...
@register_model
class New_cylinder_asym(cylinder_asym):
    def forward(self, train_pt_fea_ten, train_vox_ten, batch_size, occupy):
        coords, features_3d, occupy = self.cylinder_3d_generator(train_pt_fea_ten, train_vox_ten, occupy)

        spatial_features = self.cylinder_3d_spconv_seg(features_3d, coords, batch_size, occupy)
